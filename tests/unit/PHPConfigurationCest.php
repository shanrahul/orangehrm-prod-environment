...
class PHPConfigurationCest
{
    ...
    public function checkPHPConfig_expose_php(UnitTester $I){
        ...
        $I->runShellCommand("docker exec prod_web_ubuntu_ubuntu php -i | grep expose_php");
    ...
    public function checkPHPConfig_enable_dl(UnitTester $I){
        ...
        $I->runShellCommand("docker exec prod_web_ubuntu_ubuntu php -i | grep enable_dl");
    ...
    public function checkPHPConfig_allow_url_fopen(UnitTester $I){
        ...
        $I->runShellCommand("docker exec prod_web_ubuntu_ubuntu php -i | grep allow_url_fopen");
    ...
    public function checkPHPConfig_allow_url_include(UnitTester $I){
        ...
        $I->runShellCommand("docker exec prod_web_ubuntu_ubuntu php -i | grep allow_url_include");
    ...
    public function checkPHPConfig_display_errors(UnitTester $I){
        ...
        $I->runShellCommand("docker exec prod_web_ubuntu php -i | grep display_errors");
    ...
    public function checkPHPConfig_post_max_size(UnitTester $I){
        ...
        $I->runShellCommand("docker exec prod_web_ubuntu php -r \"echo ini_get('post_max_size');\"");
    ...
    public function checkPHPConfig_session_cookie_secure(UnitTester $I){
        ...
        $I->runShellCommand("docker exec prod_web_ubuntu php -r \"echo ini_get('session.cookie_secure');\"");
    ...
    public function checkPHPConfig_upload_max_filesize(UnitTester $I){
        ...
        $I->runShellCommand("docker exec prod_web_ubuntu php -r \"echo ini_get('upload_max_filesize');\"");
        $I->canSeeInShellOutput("50M");
    }

    public function checkPHPConfig_memory_limit(UnitTester $I){
        $I->wantTo("verify the config - memory_limit = 2048M");
        $I->runShellCommand("docker exec prod_web_ubuntu php -r \"echo ini_get('memory_limit');\"");
    ...
    public function checkPHPConfig_max_input_vars(UnitTester $I){
        ...
        $I->runShellCommand("docker exec prod_web_ubuntu php -r \"echo ini_get('max_input_vars');\"");
    ...
    public function checkPHPConfig_short_open_tag(UnitTester $I){
        ...
        $I->runShellCommand("docker exec prod_web_ubuntu php -i | grep short_open_tag");
    ...
    public function checkPHPConfig_date_timezone(UnitTester $I){
        ...
        $I->runShellCommand("docker exec prod_web_ubuntu php -r \"echo ini_get('date.timezone');\"");
