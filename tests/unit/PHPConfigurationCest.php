...
class PHPConfigurationCest
{
    ...
    public function checkPHPConfig_enable_dl(UnitTester $I){
        ...
        $I->runShellCommand("docker exec prod_web_rhel php -i | grep enable_dl");
    ...
    public function checkPHPConfig_allow_url_fopen(UnitTester $I){
        ...
        $I->runShellCommand("docker exec prod_web_rhel php -i | grep allow_url_fopen");
    ...
    public function checkPHPConfig_allow_url_include(UnitTester $I){
        ...
        $I->runShellCommand("docker exec prod_web_rhel php -i | grep allow_url_include");
    ...
    public function checkPHPConfig_display_errors(UnitTester $I){
        ...
        $I->runShellCommand("docker exec prod_web_rhel php -i | grep display_errors");
    ...
    public function checkPHPConfig_post_max_size(UnitTester $I){
        ...
        $I->runShellCommand("docker exec prod_web_rhel php -r \"echo ini_get('post_max_size');\"");
        $I->canSeeInShellOutput("50M");
    }

    public function checkPHPConfig_session_cookie_secure(UnitTester $I){
        $I->wantTo("verify the config - session.cookie_secure = 1");
        $I->runShellCommand("docker exec prod_web_rhel php -r \"echo ini_get('session.cookie_secure');\"");
